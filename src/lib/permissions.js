...
const MATRIX = {
  ...
  'quality_audit': ['asc', 'certification', 'marketing', 'admin'],
  'quality_audit.enter_audits': ['asc', 'certification', 'marketing', 'admin'],
  'quality_audit.view_own': ['agent', 'asc', 'certification', 'marketing', 'admin'],
  ...
  'schedule.accept_and_release_intervals_on_an_assigned_schedule': ['agent', 'asc', 'support', 'certification', 'admin'],
  'schedule.ability_to_assign_agents_to_schedules': ['certification', 'marketing', 'admin'],
  'schedule.view_my_schedule': ['agent', 'asc', 'support', 'certification', 'admin'],
